...
| Environmental sensors | Manual entry, sparklines, threshold alerts | USB/BLE/MQTT hardware ingestion | WP-54 |
...
**Still planned (not started):** on-chain anchoring (Dogecoin `OP_RETURN`, WP-66-era Trust Layer Phase 2), a remote API for the PWA, live S3/SFTP transport, plugin WASM execution sandbox, and federated multi-lab networks (Phase G). Full detail in the "Beyond v2.x" section.
