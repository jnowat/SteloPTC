...
### Phase F — Cross-cutting (in progress)
...
- [ ] **Advanced analytics & reporting** — trend charts, KPI dashboards, exportable multi-sheet reports (WP-58)
- [ ] **Cloud backup with E2E encryption** — S3/SFTP/NAS targets, AES-256-GCM, multi-device sync (WP-59)
- [ ] **Regulatory compliance exports** — FDA 21 CFR Part 11, USDA APHIS permit, CITES dossier (WP-60)
- [ ] **Plugin/extension system** — WASM compliance rules, vocabulary packs, `.steloplugin` format (WP-61)
...
- [ ] **Local AI analysis** — NLP summaries of observation notes; image-based contamination detection from passage photos (WP-56)
- [ ] **Offline-first PWA** — installable web app with Service Worker, IndexedDB offline queue (WP-62)
