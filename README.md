...
- [ ] **SteloMyco (Mycology)** — strain/isolate registry, colonization % tracking, fruiting conditions & yield, substrate composition (v2.1.0 target); Phase TX strain model maps directly to mycology strain concepts; `mycology` vocabulary now seeded (stages, propagation methods, substrate supplements, compliance types, agencies, inventory categories — v1.28.0)
